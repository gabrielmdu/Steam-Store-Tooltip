export async function requestAppAndUserInfo(appId, language, currency) {
    const dataInfo = {
        app: null,
        user: null
    };
...
export async function requestReviewsInfo(appId, language, purchaseType) {
...
export async function requestTagsInfo(appId) {
    let tagsInfo = null;
